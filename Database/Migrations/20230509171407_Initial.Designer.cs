...
namespace Database.Migrations
{
    ...
    [Migration("20230509171407_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Models.CameraAnalysis", b =>
                {
                    ...
                    b.ToTable("CamerasAnalyses", "public");
                });
            ...
            modelBuilder.Entity("Database.Models.UserRequestApprovedNotification", b =>
                {
                    b.HasBaseType("Database.Models.Notification");
                    ...
                    b.ToTable("Notifications", "public", t =>
                        {
                            t.Property("UserId")
                                .HasColumnName("UserRequestApprovedNotification_UserId");
                        });

                    b.HasDiscriminator().HasValue("UserRequestApprovedNotification");
                });
